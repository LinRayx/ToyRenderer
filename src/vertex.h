...
namespace Vertex {
	...
	public:
		...
		template<> struct Map<Position2D>
		{
			...
			static constexpr const uint16_t dstBinding = 0;
		};
		...
		template<> struct Map<Texture2D>
		{
			using SysType = glm::vec2;
			static constexpr VkFormat vkFormat = VK_FORMAT_R32G32_SFLOAT;
			static constexpr const uint16_t dstBinding = 1;
		};
		...
		template<> struct Map<Normal>
		{
			using SysType = glm::vec3;
			static constexpr VkFormat vkFormat = VK_FORMAT_R32G32B32_SFLOAT;
			static constexpr const uint16_t dstBinding = 2;
		};
		...
		template<> struct Map<Float3Color>
		{
			using SysType = glm::vec3;
			static constexpr VkFormat vkFormat = VK_FORMAT_R32G32B32_SFLOAT;
			static constexpr const uint16_t dstBinding = 3;
		};
		...
		public:
			...
			static VkFormat GetVkFormat(ElementType type);
