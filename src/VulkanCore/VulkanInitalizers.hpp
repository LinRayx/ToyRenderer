#ifndef VULKAN_INITALIZERS_H
#define VULKAN_INITALIZERS_H
...
{																										\
	...
	if (res != VK_SUCCESS)																				\
	{																									\
		std::cout << "Fatal : VkResult is \"" << Graphics::initializers::errorString(res) << "\" in " << __FILE__ << " at line " << __LINE__ << "\n"; \
		assert(res == VK_SUCCESS);																		\
	}																									\
}

#endif // !VULKAN_INITALIZERS_H
