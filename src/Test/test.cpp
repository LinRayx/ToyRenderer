...
public:
    ...
    virtual void Update() override
    {
        ...
        (*bufs["mvp"])["proj"] = camera_ptr->GetProjectMatrix();

        glm::mat4 tmp = (*bufs["mvp"])["model"];

        //cout << glm::to_string(this->getModelMatrix()) << endl;
        //cout << glm::to_string(tmp) << endl;
        //cout << glm::to_string(camera_ptr->GetProjectMatrix()) << endl;
